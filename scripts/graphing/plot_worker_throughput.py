...
if __name__ == "__main__":
    ...
    plot_totals_bar(sorted(cread_file_list, key=byNumWorkers), sorted(cwrite_file_list, key=byNumWorkers), cread_label_map,
                    cwrite_label_map, cread_data, cwrite_data, 'numa_zero')
